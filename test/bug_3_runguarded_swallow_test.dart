  ...
  test('runGuarded swallows unhandled exceptions silently', () async {
    ...
    runZonedGuarded(() {
      scope.runGuarded(() async {
        throw StateError('This error is completely swallowed and never observed!');
      });
    }, (error, stack) {
    ...
    expect(exceptionSwallowed, isFalse, reason: 'Bug fixed: runGuarded correctly throws exceptions.');
  });
}
